...
class SVMClassifier(ResultsMixin, BaseClassifier):
    """
    Three independent LinearSVC classifiers (one per chain level)
    with LabelEncoder for safe string-target handling.
    """
